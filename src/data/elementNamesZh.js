...
export const ELEMENT_NAMES_ZH = {
  ...
  Cs: '铯', Ba: '钡',
  La: '镧', Ce: '铈', Pr: '镨', Nd: '钕', Pm: '钷', Sm: '钐', Eu: '铕', Gd: '钆', Tb: '铽', Dy: '镝', Ho: '钬', Er: '铒', Tm: '铥', Yb: '镱', Lu: '镥',
  Hf: '铪', Ta: '钽', W: '钨', Re: '铼', Os: '锇', Ir: '铱', Pt: '铂', Au: '金', Hg: '汞',
  Tl: '铊', Pb: '铅', Bi: '铋', Po: '钋', At: '砹', Rn: '氡',
  Fr: '钫', Ra: '镭',
  Ac: '锕', Th: '钍', Pa: '镤', U: '铀', Np: '镎', Pu: '钚', Am: '镅', Cm: '锔', Bk: '锫', Cf: '锎', Es: '锿', Fm: '镄', Md: '钔', No: '锘', Lr: '铹',
  Rf: '𬬻', Db: '𬭊', Sg: '𬭳', Bh: '𬭛', Hs: '𬭶', Mt: '鿏', Ds: '𫟼', Rg: '𬬭', Cn: '鿔',
  Nh: '鉨', Fl: '𫓧', Mc: '镆', Lv: '鉝', Ts: '石田', Og: '气奥',
};
